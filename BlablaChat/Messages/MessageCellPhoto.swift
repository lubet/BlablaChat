...
#Preview {
    MessageCellPhoto(message: Messages(id: "123", salonId: "123", send: true, receiver: "123", texte: "Bonjour", dateMessage: Timestamp(), urlPhoto: "https://picsum.photos/400", sender: "123456", dateSort: Date()))
}
